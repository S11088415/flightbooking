...
body {
  ...
  background: radial-gradient(circle at 0.7% 1%, rgb(215, 248, 247) 0%, rgb(102, 188, 239) 100.2%) /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
        ...
        <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto">
          <h1 class="text-center text-light">PAY INVOICE</h1>
            <div id="pay-invoice" class="card">
                <div class="card-body">
            <!-- <label for="fname">*Mpaisa Card also Accepted</label> -->
            <i class="fa "><img src="assets/images/MpaisaLogo.png" alt="" width="40px" height="40px"></i>
